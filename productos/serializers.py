...
class ProductoSerializer(serializers.ModelSerializer):
    ...
    precio_nombre = serializers.CharField(source='precio.nombre', required=False, read_only=True)
    ...
    class Meta:
        ...
        'categoria_nombre', 'precio', 'costo', 'stock' ,'precio_unitario', 'precio_nombre' ,'precio_punto', 'precio_docena', 'estado')